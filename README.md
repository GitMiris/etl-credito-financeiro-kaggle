...
Para garantir a integridade do pipeline, o script de análise gera um relatório executivo diretamente no terminal:

> **Nota:** Abaixo, um exemplo do output real gerado pelo código, identificando as horas do dia com maior volume de fraudes.
